...
const features = [
  {
    ...
    description: 'Let AI automatically organize your tasks, prioritize your schedule, and suggest optimal workflows.',
    icon: SparklesIcon
  },
  {
    title: 'Smart Email Assistant',
    description: 'AI reads your emails, drafts responses, schedules meetings, and extracts action items automatically.',
    icon: MailIcon
  },
  {
    title: 'Unified Calendar Management',
    description: 'Coordinate across multiple calendars, find optimal meeting times, and schedule with natural language.',
    icon: CalendarIcon
  },
  {
    title: 'Cross-Platform Automation',
    description: 'Create workflows that span multiple apps. When X happens in Gmail, do Y in Slack and Z in Notion.',
    icon: CollectionIcon
  },
  {
    title: 'Intelligent Chat Interface',
    description: 'Chat with your data across all platforms. Ask questions, give commands, get insights instantly.',
    icon: ChatIcon
  }
];
...
const workflows = [
  {
    ...
    description: 'Automatically convert important emails into actionable tasks in your project management tools.',
    steps: ['Email arrives', 'AI analyzes content', 'Creates task in Linear/Notion', 'Notifies team']
  },
  {
    title: 'Meeting Preparation',
    description: 'AI prepares meeting briefings by gathering relevant emails, docs, and previous discussions.',
    steps: ['Meeting scheduled', 'Gather context', 'Create briefing doc', 'Share with attendees']
  },
  {
    title: 'Sales Lead Processing',
    description: 'New leads are automatically researched, qualified, and added to your CRM with context.',
    steps: ['Lead captured', 'Research company', 'Create HubSpot contact', 'Schedule follow-up']
  }
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Join thousands of professionals who've automated their busywork with Dash.AI
            </p>
            <button
              onClick={handleGoogleLogin}
              disabled={isLoading}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-gray-400 mt-2">The AI assistant for everything</p>
            </div>
...
export default Landing; text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Dash.AI connects to all your tools to complete entire tasks. Manage emails, schedule meetings, 
              update databases, and coordinate your team - all through natural conversation.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Unlike simple chatbots, Dash.AI takes action across your entire workflow
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Build powerful automation sequences that connect your favorite tools
            </p>
          </div>
